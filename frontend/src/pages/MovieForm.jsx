  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background-900 text-text-primary py-8">
        ...
        {/* Error Message */}
        {error && (
          <div className="bg-semantic-error/10 border border-semantic-error text-semantic-error px-4 py-3 rounded mb-6">
            {error}
          </div>
        )}
        ...
        {/* Success Message */}
        {message && (
          <div className="bg-semantic-success/10 border border-semantic-success text-semantic-success px-4 py-3 rounded mb-6">
            {message}
          </div>
        )}

        {/* Form Container */}
        <form onSubmit={handleSubmit} className="bg-background-800 rounded-lg p-6 shadow-xl">
            ...
            <div>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  maxLength={200}
                  className={`w-full px-4 py-2 bg-surface-600 text-text-primary rounded-lg border ${
                    validationErrors.title 
                      ? 'border-semantic-error focus:border-semantic-error' 
                      : 'border-secondary-400 focus:border-primary-500'
